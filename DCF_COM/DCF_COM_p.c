...
typedef struct _DCF_COM_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } DCF_COM_MIDL_TYPE_FORMAT_STRING;

typedef struct _DCF_COM_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } DCF_COM_MIDL_PROC_FORMAT_STRING;

typedef struct _DCF_COM_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } DCF_COM_MIDL_EXPR_FORMAT_STRING;
...
extern const DCF_COM_MIDL_TYPE_FORMAT_STRING DCF_COM__MIDL_TypeFormatString;
extern const DCF_COM_MIDL_PROC_FORMAT_STRING DCF_COM__MIDL_ProcFormatString;
extern const DCF_COM_MIDL_EXPR_FORMAT_STRING DCF_COM__MIDL_ExprFormatString;
...
static const DCF_COM_MIDL_PROC_FORMAT_STRING DCF_COM__MIDL_ProcFormatString =
    {
        0,
        {
...
static const DCF_COM_MIDL_TYPE_FORMAT_STRING DCF_COM__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
/* Object interface: IDCF_Tools, ver. 0.0,
   GUID={0xB040A339,0xBBEC,0x491F,{0xB1,0x51,0x22,0x28,0xDD,0x10,0xD3,0xCC}} */

#pragma code_seg(".orpc")
static const unsigned short IDCF_Tools_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IDCF_Tools_ProxyInfo =
    ...
    &IDCF_Tools_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IDCF_Tools_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    DCF_COM__MIDL_ProcFormatString.Format,
...
static const PRPC_STUB_FUNCTION IDCF_Tools_table[] =
{
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    DCF_COM__MIDL_TypeFormatString.Format,
...
#define _DCF_COM_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _DCF_COM, pIID, n)
...
{
    (PCInterfaceProxyVtblList *) & _DCF_COM_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _DCF_COM_StubVtblList,
